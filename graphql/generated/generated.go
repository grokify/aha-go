...
// CreateFeatureWithAssignmentsCreateFeatureCreateFeaturePayload includes the requested fields of the GraphQL type CreateFeaturePayload.
// The GraphQL type's documentation follows.
//
...
// CreateFeatureWithAssignmentsCreateFeatureCreateFeaturePayloadErrors includes the requested fields of the GraphQL type Errors.
// The GraphQL type's documentation follows.
//
// All errors on invalid attributes
...
// CreateFeatureWithAssignmentsCreateFeatureCreateFeaturePayloadErrorsAttributesAttributeErrors includes the requested fields of the GraphQL type AttributeErrors.
// The GraphQL type's documentation follows.
//
// A set of errors on a single attribute
...
// CreateFeatureWithAssignmentsCreateFeatureCreateFeaturePayloadFeature includes the requested fields of the GraphQL type Feature.
// The GraphQL type's documentation follows.
//
// A basic record representing work to be done
...
// CreateFeatureWithAssignmentsCreateFeatureCreateFeaturePayloadFeatureEpic includes the requested fields of the GraphQL type Epic.
// The GraphQL type's documentation follows.
//
// A high-level record that can contain multiple related features
...
// CreateFeatureWithAssignmentsCreateFeatureCreateFeaturePayloadFeatureInitiative includes the requested fields of the GraphQL type Initiative.
// The GraphQL type's documentation follows.
//
// Initiatives are high-level efforts that you will complete in order to achieve each goal
...
// CreateFeatureWithAssignmentsCreateFeatureCreateFeaturePayloadFeatureRelease includes the requested fields of the GraphQL type Release.
// The GraphQL type's documentation follows.
//
// A group of records with a release date or theme
...
// CreateFeatureWithAssignmentsCreateFeatureCreateFeaturePayloadFeatureTagsTag includes the requested fields of the GraphQL type Tag.
// The GraphQL type's documentation follows.
//
// A tag on a record
...
// CreateFeatureWithAssignmentsCreateFeatureCreateFeaturePayloadFeatureWorkflowStatus includes the requested fields of the GraphQL type WorkflowStatus.
// The GraphQL type's documentation follows.
//
...
func (v *CreateFeatureWithAssignmentsResponse) GetCreateFeature() *CreateFeatureWithAssignmentsCreateFeatureCreateFeaturePayload {
	return v.CreateFeature
}

// CreateFeatureWithProjectCreateFeatureCreateFeaturePayload includes the requested fields of the GraphQL type CreateFeaturePayload.
// The GraphQL type's documentation follows.
//
// Autogenerated return type of CreateFeature.
...
// CreateFeatureWithProjectCreateFeatureCreateFeaturePayloadErrors includes the requested fields of the GraphQL type Errors.
// The GraphQL type's documentation follows.
//
// All errors on invalid attributes
...
// CreateFeatureWithProjectCreateFeatureCreateFeaturePayloadErrorsAttributesAttributeErrors includes the requested fields of the GraphQL type AttributeErrors.
// The GraphQL type's documentation follows.
//
// A set of errors on a single attribute
...
// CreateFeatureWithProjectCreateFeatureCreateFeaturePayloadFeature includes the requested fields of the GraphQL type Feature.
// The GraphQL type's documentation follows.
//
// A basic record representing work to be done
...
// CreateFeatureWithProjectCreateFeatureCreateFeaturePayloadFeatureProject includes the requested fields of the GraphQL type Project.
// The GraphQL type's documentation follows.
//
...
// CreateFeatureWithProjectCreateFeatureCreateFeaturePayloadFeatureTagsTag includes the requested fields of the GraphQL type Tag.
// The GraphQL type's documentation follows.
//
// A tag on a record
...
func (v *CreateFeatureWithProjectCreateFeatureCreateFeaturePayloadFeatureTagsTag) GetId() string {
	return v.Id
}
...
// CreateFeatureWithReleaseCreateFeatureCreateFeaturePayload includes the requested fields of the GraphQL type CreateFeaturePayload.
// The GraphQL type's documentation follows.
//
// Autogenerated return type of CreateFeature.
...
// CreateFeatureWithReleaseCreateFeatureCreateFeaturePayloadErrors includes the requested fields of the GraphQL type Errors.
// The GraphQL type's documentation follows.
//
// All errors on invalid attributes
...
// CreateFeatureWithReleaseCreateFeatureCreateFeaturePayloadErrorsAttributesAttributeErrors includes the requested fields of the GraphQL type AttributeErrors.
// The GraphQL type's documentation follows.
//
// A set of errors on a single attribute
...
// CreateFeatureWithReleaseCreateFeatureCreateFeaturePayloadFeature includes the requested fields of the GraphQL type Feature.
// The GraphQL type's documentation follows.
//
// A basic record representing work to be done
...
// CreateFeatureWithReleaseCreateFeatureCreateFeaturePayloadFeatureRelease includes the requested fields of the GraphQL type Release.
// The GraphQL type's documentation follows.
//
// A group of records with a release date or theme
...
// CreateFeatureWithReleaseCreateFeatureCreateFeaturePayloadFeatureTagsTag includes the requested fields of the GraphQL type Tag.
// The GraphQL type's documentation follows.
//
// A tag on a record
...
func (v *CreateFeatureWithReleaseCreateFeatureCreateFeaturePayloadFeatureTagsTag) GetId() string {
	return v.Id
}
...
// CreateIdeaCreateIdeaCreateIdeaPayload includes the requested fields of the GraphQL type CreateIdeaPayload.
// The GraphQL type's documentation follows.
//
...
// CreateIdeaCreateIdeaCreateIdeaPayloadErrors includes the requested fields of the GraphQL type Errors.
// The GraphQL type's documentation follows.
//
// All errors on invalid attributes
...
// CreateIdeaCreateIdeaCreateIdeaPayloadErrorsAttributesAttributeErrors includes the requested fields of the GraphQL type AttributeErrors.
// The GraphQL type's documentation follows.
//
// A set of errors on a single attribute
...
// CreateIdeaCreateIdeaCreateIdeaPayloadIdea includes the requested fields of the GraphQL type Idea.
// The GraphQL type's documentation follows.
//
// An idea
...
func (v *CreateIdeaCreateIdeaCreateIdeaPayloadIdea) GetId() string { return v.Id }
...
func (v *CreateIdeaCreateIdeaCreateIdeaPayloadIdea) GetReferenceNum() string { return v.ReferenceNum }

// GetName returns CreateIdeaCreateIdeaCreateIdeaPayloadIdea.Name, and is useful for accessing the field via an interface.
func (v *CreateIdeaCreateIdeaCreateIdeaPayloadIdea) GetName() string { return v.Name }
...
func (v *CreateIdeaCreateIdeaCreateIdeaPayloadIdea) GetCreatedAt() time.Time { return v.CreatedAt }
...
func (v *CreateIdeaCreateIdeaCreateIdeaPayloadIdea) GetUpdatedAt() time.Time { return v.UpdatedAt }

// CreateIdeaCreateIdeaCreateIdeaPayloadIdeaWorkflowStatus includes the requested fields of the GraphQL type WorkflowStatus.
// The GraphQL type's documentation follows.
//
// A single status within a workflow
...
func (v *CreateIdeaCreateIdeaCreateIdeaPayloadIdeaWorkflowStatus) GetId() string { return v.Id }
...
func (v *CreateIdeaCreateIdeaCreateIdeaPayloadIdeaWorkflowStatus) GetName() string { return v.Name }
...
var AllCustomFieldableTypeEnum = []CustomFieldableTypeEnum{
	CustomFieldableTypeEnumProject,
	CustomFieldableTypeEnumTask,
	CustomFieldableTypeEnumRelease,
	CustomFieldableTypeEnumEpic,
	CustomFieldableTypeEnumSchedulingteam,
	CustomFieldableTypeEnumPage,
	CustomFieldableTypeEnumFeature,
	CustomFieldableTypeEnumGoal,
	CustomFieldableTypeEnumInitiative,
	CustomFieldableTypeEnumIdea,
	CustomFieldableTypeEnumRequirement,
	CustomFieldableTypeEnumReleasephase,
	CustomFieldableTypeEnumIdeauser,
	CustomFieldableTypeEnumKeyresult,
	CustomFieldableTypeEnumProgramincrement,
	CustomFieldableTypeEnumDiscoverystudy,
	CustomFieldableTypeEnumDiscoveryinterview,
	CustomFieldableTypeEnumNotetemplate,
	CustomFieldableTypeEnumCompetitor,
	CustomFieldableTypeEnumPersona,
...
func (v *SetCustomFieldValuesResponse) GetSetCustomFieldValues() *SetCustomFieldValuesSetCustomFieldValuesSetCustomFieldValuesPayload {
	return v.SetCustomFieldValues
}

// SetCustomFieldValuesSetCustomFieldValuesSetCustomFieldValuesPayload includes the requested fields of the GraphQL type SetCustomFieldValuesPayload.
// The GraphQL type's documentation follows.
//
...
// SetCustomFieldValuesSetCustomFieldValuesSetCustomFieldValuesPayloadCustomFieldValuesCustomFieldValue includes the requested fields of the GraphQL type CustomFieldValue.
// The GraphQL type's documentation follows.
//
// A custom field value on a record
...
// SetCustomFieldValuesSetCustomFieldValuesSetCustomFieldValuesPayloadErrors includes the requested fields of the GraphQL type Errors.
// The GraphQL type's documentation follows.
//
// All errors on invalid attributes
...
// SetCustomFieldValuesSetCustomFieldValuesSetCustomFieldValuesPayloadErrorsAttributesAttributeErrors includes the requested fields of the GraphQL type AttributeErrors.
// The GraphQL type's documentation follows.
//
// A set of errors on a single attribute
...
// __CreateFeatureWithAssignmentsInput is used internally by genqlient
type __CreateFeatureWithAssignmentsInput struct {
	Name                         string  `json:"name"`
	ReleaseId                    string  `json:"releaseId"`
	...
	SkipRequiredFieldsValidation *bool   `json:"skipRequiredFieldsValidation"`
}

// GetName returns __CreateFeatureWithAssignmentsInput.Name, and is useful for accessing the field via an interface.
func (v *__CreateFeatureWithAssignmentsInput) GetName() string { return v.Name }

// GetReleaseId returns __CreateFeatureWithAssignmentsInput.ReleaseId, and is useful for accessing the field via an interface.
func (v *__CreateFeatureWithAssignmentsInput) GetReleaseId() string { return v.ReleaseId }

// GetDescription returns __CreateFeatureWithAssignmentsInput.Description, and is useful for accessing the field via an interface.
func (v *__CreateFeatureWithAssignmentsInput) GetDescription() *string { return v.Description }

// GetAssignedToUserId returns __CreateFeatureWithAssignmentsInput.AssignedToUserId, and is useful for accessing the field via an interface.
func (v *__CreateFeatureWithAssignmentsInput) GetAssignedToUserId() string { return v.AssignedToUserId }

// GetWorkflowStatusId returns __CreateFeatureWithAssignmentsInput.WorkflowStatusId, and is useful for accessing the field via an interface.
func (v *__CreateFeatureWithAssignmentsInput) GetWorkflowStatusId() string { return v.WorkflowStatusId }

// GetEpicId returns __CreateFeatureWithAssignmentsInput.EpicId, and is useful for accessing the field via an interface.
func (v *__CreateFeatureWithAssignmentsInput) GetEpicId() string { return v.EpicId }

// GetInitiativeId returns __CreateFeatureWithAssignmentsInput.InitiativeId, and is useful for accessing the field via an interface.
func (v *__CreateFeatureWithAssignmentsInput) GetInitiativeId() string { return v.InitiativeId }

// GetTagList returns __CreateFeatureWithAssignmentsInput.TagList, and is useful for accessing the field via an interface.
func (v *__CreateFeatureWithAssignmentsInput) GetTagList() *string { return v.TagList }

// GetSkipRequiredFieldsValidation returns __CreateFeatureWithAssignmentsInput.SkipRequiredFieldsValidation, and is useful for accessing the field via an interface.
func (v *__CreateFeatureWithAssignmentsInput) GetSkipRequiredFieldsValidation() *bool {
	return v.SkipRequiredFieldsValidation
}

// __CreateFeatureWithProjectInput is used internally by genqlient
type __CreateFeatureWithProjectInput struct {
	Name                         string  `json:"name"`
...
// GetName returns __CreateFeatureWithProjectInput.Name, and is useful for accessing the field via an interface.
func (v *__CreateFeatureWithProjectInput) GetName() string { return v.Name }

// GetProjectId returns __CreateFeatureWithProjectInput.ProjectId, and is useful for accessing the field via an interface.
func (v *__CreateFeatureWithProjectInput) GetProjectId() string { return v.ProjectId }

// GetDescription returns __CreateFeatureWithProjectInput.Description, and is useful for accessing the field via an interface.
func (v *__CreateFeatureWithProjectInput) GetDescription() *string { return v.Description }

// GetTagList returns __CreateFeatureWithProjectInput.TagList, and is useful for accessing the field via an interface.
func (v *__CreateFeatureWithProjectInput) GetTagList() *string { return v.TagList }

// GetSkipRequiredFieldsValidation returns __CreateFeatureWithProjectInput.SkipRequiredFieldsValidation, and is useful for accessing the field via an interface.
func (v *__CreateFeatureWithProjectInput) GetSkipRequiredFieldsValidation() *bool {
	return v.SkipRequiredFieldsValidation
}

// __CreateFeatureWithReleaseInput is used internally by genqlient
type __CreateFeatureWithReleaseInput struct {
	Name                         string  `json:"name"`
	ReleaseId                    string  `json:"releaseId"`
	Description                  *string `json:"description"`
	TagList                      *string `json:"tagList"`
...
// GetName returns __CreateFeatureWithReleaseInput.Name, and is useful for accessing the field via an interface.
func (v *__CreateFeatureWithReleaseInput) GetName() string { return v.Name }

// GetReleaseId returns __CreateFeatureWithReleaseInput.ReleaseId, and is useful for accessing the field via an interface.
func (v *__CreateFeatureWithReleaseInput) GetReleaseId() string { return v.ReleaseId }

// GetDescription returns __CreateFeatureWithReleaseInput.Description, and is useful for accessing the field via an interface.
func (v *__CreateFeatureWithReleaseInput) GetDescription() *string { return v.Description }

// GetTagList returns __CreateFeatureWithReleaseInput.TagList, and is useful for accessing the field via an interface.
func (v *__CreateFeatureWithReleaseInput) GetTagList() *string { return v.TagList }

// GetSkipRequiredFieldsValidation returns __CreateFeatureWithReleaseInput.SkipRequiredFieldsValidation, and is useful for accessing the field via an interface.
func (v *__CreateFeatureWithReleaseInput) GetSkipRequiredFieldsValidation() *bool {
	return v.SkipRequiredFieldsValidation
}
...
// GetName returns __CreateIdeaInput.Name, and is useful for accessing the field via an interface.
func (v *__CreateIdeaInput) GetName() string { return v.Name }

// GetProjectId returns __CreateIdeaInput.ProjectId, and is useful for accessing the field via an interface.
func (v *__CreateIdeaInput) GetProjectId() string { return v.ProjectId }

// GetSkipRequiredFieldsValidation returns __CreateIdeaInput.SkipRequiredFieldsValidation, and is useful for accessing the field via an interface.
func (v *__CreateIdeaInput) GetSkipRequiredFieldsValidation() *bool {
	return v.SkipRequiredFieldsValidation
}
...
// __SetCustomFieldValuesInput is used internally by genqlient
type __SetCustomFieldValuesInput struct {
	RecordId          string                  `json:"recordId"`
	RecordTypename    CustomFieldableTypeEnum `json:"recordTypename"`
	CustomFieldValues []CustomFieldValueInput `json:"customFieldValues"`
}

// GetRecordId returns __SetCustomFieldValuesInput.RecordId, and is useful for accessing the field via an interface.
func (v *__SetCustomFieldValuesInput) GetRecordId() string { return v.RecordId }

// GetRecordTypename returns __SetCustomFieldValuesInput.RecordTypename, and is useful for accessing the field via an interface.
func (v *__SetCustomFieldValuesInput) GetRecordTypename() CustomFieldableTypeEnum {
	return v.RecordTypename
}

// GetCustomFieldValues returns __SetCustomFieldValuesInput.CustomFieldValues, and is useful for accessing the field via an interface.
func (v *__SetCustomFieldValuesInput) GetCustomFieldValues() []CustomFieldValueInput {
	return v.CustomFieldValues
}
...
const CreateFeatureWithAssignments_Operation = `
mutation CreateFeatureWithAssignments ($name: String!, $releaseId: ID!, $description: String, $assignedToUserId: ID!, $workflowStatusId: ID!, $epicId: ID!, $initiativeId: ID!, $tagList: String, $skipRequiredFieldsValidation: Boolean) {
	createFeature(attributes: {name:$name,release:{id:$releaseId},description:$description,assignedToUser:{id:$assignedToUserId},workflowStatus:{id:$workflowStatusId},epic:{id:$epicId},initiative:{id:$initiativeId},tagList:$tagList}, skipRequiredFieldsValidation: $skipRequiredFieldsValidation) {
		feature {
			id
			referenceNum
			name
...
// Create a feature with all assignment options
// Note: Initiative is required (ID!) when specified
func CreateFeatureWithAssignments(
	...
	req_ := &graphql.Request{
		OpName: "CreateFeatureWithAssignments",
		Query:  CreateFeatureWithAssignments_Operation,
		Variables: &__CreateFeatureWithAssignmentsInput{
			Name:                         name,
			ReleaseId:                    releaseId,
			...
			InitiativeId:                 initiativeId,
			TagList:                      tagList,
			SkipRequiredFieldsValidation: skipRequiredFieldsValidation,
		},
	}

	data_ = &CreateFeatureWithAssignmentsResponse{}
	resp_ := &graphql.Response{Data: data_}
...
const CreateFeatureWithProject_Operation = `
mutation CreateFeatureWithProject ($name: String!, $projectId: ID!, $description: String, $tagList: String, $skipRequiredFieldsValidation: Boolean) {
	createFeature(attributes: {name:$name,project:{id:$projectId},description:$description,tagList:$tagList}, skipRequiredFieldsValidation: $skipRequiredFieldsValidation) {
		feature {
			id
			referenceNum
			name
...
func CreateFeatureWithProject(
	...
	req_ := &graphql.Request{
		OpName: "CreateFeatureWithProject",
		Query:  CreateFeatureWithProject_Operation,
		Variables: &__CreateFeatureWithProjectInput{
			Name:                         name,
			ProjectId:                    projectId,
			Description:                  description,
			TagList:                      tagList,
	...
	data_ = &CreateFeatureWithProjectResponse{}
	resp_ := &graphql.Response{Data: data_}
...
const CreateFeatureWithRelease_Operation = `
mutation CreateFeatureWithRelease ($name: String!, $releaseId: ID!, $description: String, $tagList: String, $skipRequiredFieldsValidation: Boolean) {
	createFeature(attributes: {name:$name,release:{id:$releaseId},description:$description,tagList:$tagList}, skipRequiredFieldsValidation: $skipRequiredFieldsValidation) {
		feature {
			id
			referenceNum
			name
...
// Create a feature with release (most common use case)
// Use skipRequiredFieldsValidation=true to bypass custom required field validation
func CreateFeatureWithRelease(
	...
	req_ := &graphql.Request{
		OpName: "CreateFeatureWithRelease",
		Query:  CreateFeatureWithRelease_Operation,
		Variables: &__CreateFeatureWithReleaseInput{
			Name:                         name,
			ReleaseId:                    releaseId,
			Description:                  description,
			TagList:                      tagList,
	...
	data_ = &CreateFeatureWithReleaseResponse{}
	resp_ := &graphql.Response{Data: data_}
...
mutation CreateIdea ($name: String!, $projectId: ID!, $skipRequiredFieldsValidation: Boolean) {
	createIdea(attributes: {name:$name,project:{id:$projectId}}, skipRequiredFieldsValidation: $skipRequiredFieldsValidation) {
		idea {
			id
			referenceNum
			name
...
// Create a new idea
// Note: Description and tags must be set via separate mutations (UpdateIdea, etc.)
func CreateIdea(
	ctx_ context.Context,
	client_ graphql.Client,
	name string,
...
const SetCustomFieldValues_Operation = `
mutation SetCustomFieldValues ($recordId: ID!, $recordTypename: CustomFieldableTypeEnum!, $customFieldValues: [CustomFieldValueInput!]!) {
	setCustomFieldValues(attributes: {record:{id:$recordId,typename:$recordTypename},customFieldValues:$customFieldValues}) {
		customFieldValues {
			id
			key
			value
...
func SetCustomFieldValues(
	...
	req_ := &graphql.Request{
		OpName: "SetCustomFieldValues",
		Query:  SetCustomFieldValues_Operation,
		Variables: &__SetCustomFieldValuesInput{
			RecordId:          recordId,
	...
	data_ = &SetCustomFieldValuesResponse{}
	resp_ := &graphql.Response{Data: data_}
